var ChartsAmcharts = function() {
    ...
    var initChartSample14 = function() {
        ...
        $('#chart_14').closest('.portlet').find('.fullscreen').click(function() {
            chart.invalidateSize();
        });
    }

    var initChartSample15 = function() {
        ...
        $('#chart_15').closest('.portlet').find('.fullscreen').click(function() {
            chart.invalidateSize();
        });
    }
